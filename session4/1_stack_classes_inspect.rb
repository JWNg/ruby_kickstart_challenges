...
class Stack
  ...
  def inspect
    ...
    object = self.head
    begin 
      string = string + object.data.inspect unless object == nil
      string << ")" 
      object = object.next_node unless object == nil 
      break if object == nil
      if object.next_node == nil
        string = string + object.data.inspect unless object == nil
        string << ")"
      end
    end until object.next_node == nil
    p string
  end
end

#stack2 = Stack.new
#(1..3).each { |i| stack2.push i }
#stack2.push(/abc/)
#stack2.inspect
